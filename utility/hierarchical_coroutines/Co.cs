...
namespace framework.utility.hierarchical_coroutines
{
    ...
    public static partial class Co
    {
        ...
        public static WaitDelayCoroutine Wait(float delay, bool ignoreTimeScale = false,
            CoRunMode runMode = CoRunMode.Inherit)
            => new WaitDelayCoroutine(delay, ignoreTimeScale, runMode);

        public static WaitDelayCoroutine Sleep(float delay, bool ignoreTimeScale = false,
            CoRunMode runMode = CoRunMode.Inherit)
            => new WaitDelayCoroutine(delay, ignoreTimeScale, runMode);

        public static WaitDelayCoroutine Delay(float delay, bool ignoreTimeScale = false,
            CoRunMode runMode = CoRunMode.Inherit)
            => new WaitDelayCoroutine(delay, ignoreTimeScale, runMode);
