    ...
    public class ISaveSystem : IService
    {
        ...
        public void SaveGame(int slot, GameSaveData data)
        {
            try
            {
                ...
                ServiceLocator.Instance.GetService<IEventBus>("EventBus")?.Publish(new GameSavedEvent { Slot = slot });
            }
            catch (Exception e)
            {
        ...
        public GameSaveData LoadGame(int slot)
        {
            try
            {
                ...
                ServiceLocator.Instance.GetService<IEventBus>("EventBus")?.Publish(new GameLoadedEvent { Slot = slot });
